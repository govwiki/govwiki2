...
initTableHandlers = function(person) {
  ...
  $('table').on('click', '.add', function(e) {
    var currentEntity, tabPane, tableType;
    ...
    return $.post('http://45.55.0.145/api/createrequest/new', {
      ...
      var endObj, key, option, results, select;
      endObj = {};
