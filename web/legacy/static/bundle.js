...
$('#dataContainer').on('click', function(e) {
  var $element, additionalRowsTpl, currentPage, fieldName, fieldNameInCamelCase, formatData, loadNewRows, loading, mask, popoverContent, popoverOrder, popoverTpl, preloader, previousScrollTop;
  $element = $(e.target);
  ...
  formatData = function(data) {
    if (mask) {
      return data.forEach(function(rank) {
  ...
  loadNewRows = function(order) {
    ...
    table.html('');
    currentPage = order !== void 0 ? order : currentPage;
    previousScrollTop = 0;
