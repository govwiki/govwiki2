...
$('#dataContainer').on('click', function(e) {
  var $element, additionalRowsTpl, currentPage, fieldName, fieldNameInCamelCase, loadNewRows, loading, popoverContent, popoverTpl, preloader, previousScrollTop;
  $element = $(e.target);
