...
$(function() {
  ...
  return $.ajax('/api/user', {
    ...
    success: function(response) {
      ...
      $userBtnLink.html("Sign Out" + $userBtnLink.html()).click(function() {
