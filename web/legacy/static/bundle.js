...
-----------------------------------------------------------------------------------------------------------------
 */
var GovSelector, Templates2, activate_tab, active_tab, adjust_typeahead_width, authorized, build_select_element, build_selector, draw_polygons, focus_search_field, get_counties, get_elected_officials, get_financial_statements, get_max_ranks, get_record2, gov_selector, govmap, initTableHandlers, refresh_disqus, route, routeType, showCreateRequests, sortTable, start_adjusting_typeahead_width, templates, undef, user, wikipedia;
...
initTableHandlers = function(person) {
  ...
  return window.addItem = function(e) {
    var add, associations, childs, data, entityType, i, legislation, len, modal, modalType, newRecord, obj, ref, select, selectName, selectedText, selectedValue, sendObject;
    newRecord = {};
    ...
    if (modalType === 'addVotes') {
      ...
      if (add) {
        ...
        $('#Votes tr:last-child').before(rowTemplate({
...
showCreateRequests = function(createRequests) {
  var i, lastTr, len, name, request, results;
  results = [];
  for (i = 0, len = createRequests.length; i < len; i++) {
    ...
    results.push(lastTr = $("\#" + name + " tr:last-child"));
  }
  return results;
};
