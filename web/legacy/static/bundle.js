...
$('#dataContainer').on('click', function(e) {
  ...
  loadNewRows = function(order) {
    ...
    table.html('');
    currentPage = order !== void 0 ? 0 : currentPage;
    previousScrollTop = 0;
