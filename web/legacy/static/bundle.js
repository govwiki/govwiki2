...
$(function() {
  ...
  if (data && ((Number(window.localStorage.getItem('points_last_update')) + pointsCacheLifetime) >= date.getTime())) {
    ...
    get_records2(GOVWIKI.gov_type_filter_2, function(data) {
      ...
      return $(document).trigger('markersLoaded');
    });
  }
  rerender_markers();
