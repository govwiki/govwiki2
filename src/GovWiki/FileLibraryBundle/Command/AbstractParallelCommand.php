...
use GovWiki\FileLibraryBundle\Command\Output\MainProcessOutput;
use GovWiki\FileLibraryBundle\Command\Output\WorkerProcessOutput;
...
abstract class AbstractParallelCommand extends Command
{
    ...
    /**
     * @param resource $queue Queue resource.
     *
     * @return void
     */
    protected static function waitUntilQueueIsEmpty($queue)
    {
