...
<script id="person-info-template" type="text/x-handlebars-template">
                                ...
                                {{#this}}
                                    ...
                                    <td data-name="{{legislation.name}}">
                                        <a href="javascript:void(0);" data-type="textarea" data-pk="1"
                                           data-placeholder="Please edit name" data-title="Please edit name"
    ...
    <!-- Votes Modal -->
    <div class="modal fade" id="addVotes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-body">
                    <form name="addVotes">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Please enter Title of Measure">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Summary of Measure: </span>
                            <input type="text" class="form-control" placeholder="Please enter Summary of Measure">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">How official Voted: </span>
                            <input type="text" class="form-control" placeholder="Please enter How official Voted">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Sponsored by this official? </span>
                            <input type="text" class="form-control" placeholder="Sponsored by this official?">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Category: </span>
                            <input type="text" class="form-control" placeholder="Please enter your Category">
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form name="addContributions">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Please enter Election Year">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Name of contributor: </span>
                            <input type="text" class="form-control" placeholder="Please enter Name of contributor">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Ind. Exp. Desc.: </span>
                            <input type="text" class="form-control" placeholder="Please enter Ind. Exp. Desc.">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Please enter Contributor Type">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <form name="addEndorsements">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Please enter Type">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
