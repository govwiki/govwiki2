...
class Version20160211152217 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `generated_keys` (id INT AUTO_INCREMENT NOT NULL, vote_id INT DEFAULT NULL, `key` VARCHAR(255) NOT NULL, created DATE NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_B48E44EC72DCDAFC (vote_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `generated_keys` ADD CONSTRAINT FK_B48E44EC72DCDAFC FOREIGN KEY (vote_id) REFERENCES elected_officials_votes (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE `generated_keys`');
