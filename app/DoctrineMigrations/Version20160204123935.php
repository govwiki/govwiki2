...
class Version20160204123935 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE governments ADD mayor_name secondary_logo_path VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE DROP secondary_logo_path mayor_name VARCHAR(255) DEFAULT NULL');
    }
}
