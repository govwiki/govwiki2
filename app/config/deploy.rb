...
# Directories
set :writable_dirs,         [app_path + "/cache", app_path + "/logs", web_path + "/documents", web_path + "/government", web_path + "/upload", web_path + "/mobile", app_path + "/../static"]
set :shared_files,          ["app/config/parameters.yml"]
set :shared_children,       [app_path + "/logs", web_path + "/img", web_path + "/documents", web_path + "/government", web_path + "/upload", web_path + "/mobile", app_path + "/../static"]
